...
path = Path('weather_data/Traverse Weather 1980 to 2023 Edited.csv')
...
plt.figure()
plt.plot(dates1980, lows1980, label='Temperatures in 1980')
plt.xlabel('Year')
plt.ylabel('Temperature')
plt.title('Temps in 1980')
plt.legend()

plt.figure()
plt.plot(dates2023, lows2023, label='Temperatures in 2023')
plt.xlabel('Year')
plt.ylabel('Temperature')
plt.title('Temps in 2023')
plt.legend()
...
fig, ax = plt.subplots()
ax.plot(dates1980, lows1980, color='red', alpha=.5)
ax.plot(dates1980, lows2023, color='blue', alpha=.5)
